...
import '@synthra-swap/v3-core/contracts/libraries/TickBitmap.sol';
...
contract QuoterV2 is IQuoterV2, ISynthraV3SwapCallback, PeripheryImmutableState {
    ...
    function getPool(
        ...
        address tokenB,
        uint24 fee
    ) private view returns (ISynthraV3Pool) {
        return ISynthraV3Pool(PoolAddress.computeAddress(factory, PoolAddress.getPoolKey(tokenA, tokenB, fee)));
    }

    /// @inheritdoc ISynthraV3SwapCallback
    function synthraV3SwapCallback(
        ...
        ISynthraV3Pool pool = getPool(tokenIn, tokenOut, fee);
        ...
        )
    {
        ...
        ISynthraV3Pool pool = getPool(params.tokenIn, params.tokenOut, params.fee);
